...
function openCart(e){
	...
	if(cartData !== null){
		totalItems = '<table class="shopping_list"><tr><th>Image</th><th>Name of product</th><th>Price</th><th>Quantity</th><th>Del</th></tr>';
		...
		totalItems += '<tr><td><strong>Total</strong></td><td></td><td><span id="total_sum">'+ totalSum +'</span> $</td><td><span id="total_count">'+ totalCount +'</span> Pc.</td><td></td></tr>';
		totalItems += '<table>';
...
addEvent(d.getElementById('clear_cart'), 'click', function(e){
	...
	cartCont.innerHTML = 'Cart empty.';	
});
console.log(addEvent(d.getElementsByClassName('input.val()')))